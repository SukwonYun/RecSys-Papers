...
def train(model, optimizer, data_loader, criterion, device, log_interval = 100):
    ...
    for i, (fields, target) in enumerate(tk0):
        #fields iterate by the batch size we set
...
def main(dataset_name,
    ...
    model = WideAndDeep(field_dims, embed_dims=16, mlp_dims=(16,16), dropout = 0.3).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', default='WD-checkpoint')
